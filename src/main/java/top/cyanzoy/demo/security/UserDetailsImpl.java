package top.cyanzoy.demo.security;
...
import top.cyanzoy.demo.service.RoleService;
...
public class UserDetailsImpl implements UserDetails {
    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        ...
        for(Role role : roles) {
            authorities.add(new SimpleGrantedAuthority(role.getRole_user()));
        }
        return authorities;
    }
